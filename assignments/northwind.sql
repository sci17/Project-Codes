...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`privileges` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`employee_privileges` ;
...
CREATE TABLE IF NOT EXISTS `northwind`.`employee_privileges` (
  ...
  INDEX `privilege_id_2` (`privilege_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`orders_tax_status` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`orders_status` ;
...
CREATE TABLE IF NOT EXISTS `northwind`.`orders` (
  ...
  INDEX `tax_status` (`tax_status_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`purchase_order_status` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`purchase_orders` ;
...
CREATE TABLE IF NOT EXISTS `northwind`.`purchase_orders` (
  ...
  INDEX `supplier_id_2` (`supplier_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `northwind`.`inventory_transactions` (
  ...
  PRIMARY KEY (`id`),
  INDEX `customer_order_id` (`customer_order_id` ASC) VISIBLE,
  INDEX `customer_order_id_2` (`customer_order_id` ASC) VISIBLE,
  INDEX `product_id` (`product_id` ASC) VISIBLE,
  INDEX `product_id_2` (`product_id` ASC) VISIBLE,
  INDEX `purchase_order_id` (`purchase_order_id` ASC) VISIBLE,
  INDEX `purchase_order_id_2` (`purchase_order_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`order_details_status` ;
...
CREATE TABLE IF NOT EXISTS `northwind`.`order_details` (
  ...
  INDEX `fk_order_details_order_details_status1_idx` (`status_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `northwind`.`purchase_order_details` (
  ...
  INDEX `id` (`id` ASC) VISIBLE,
  INDEX `inventory_id` (`inventory_id` ASC) VISIBLE,
  INDEX `inventory_id_2` (`inventory_id` ASC) VISIBLE,
  INDEX `purchase_order_id` (`purchase_order_id` ASC) VISIBLE,
  INDEX `product_id` (`product_id` ASC) VISIBLE,
  INDEX `product_id_2` (`product_id` ASC) VISIBLE,
  INDEX `purchase_order_id_2` (`purchase_order_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`sales_reports` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `northwind`.`strings` ;
