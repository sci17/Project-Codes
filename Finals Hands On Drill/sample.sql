...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`job_positions` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`contract_types` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`institutions` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`service_records` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`departments` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_unitassignments` (
  `employees_idemployees` INT NOT NULL,
  ...
  CONSTRAINT `fk_employees_has_departments_departments1`
    ...
    REFERENCES `new`.`departments` (`iddepartments`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`trainings` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_has_trainings` (
  `employees_idemployees` INT NOT NULL,
  ...
  CONSTRAINT `fk_employees_has_trainings_trainings1`
    ...
    REFERENCES `new`.`trainings` (`idtrainings`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`Relatives` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_relatives` (
  `Relatives_idrelatives` INT NULL,
  ...
  CONSTRAINT `fk_Relatives_has_employees_Relatives1`
    ...
    REFERENCES `new`.`Relatives` (`idrelatives`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_education` (
  `institutions_idinstitutions` INT NOT NULL,
  `employees_idemployees` INT NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`professional_exams` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_prof_eligibility` (
  ...
  CONSTRAINT `fk_professional_exams_has_employees_professional_exams1`
    ...
    REFERENCES `new`.`professional_exams` (`idprofessional_exams`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`employees_ext_involvements` (
  `employees_idemployees` INT NOT NULL,
  `institutions_idinstitutions` INT NOT NULL,
...
-- Table `mydb`.`skills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`skills` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `new`.`skills_has_employees` (
  ...
  CONSTRAINT `fk_skills_has_employees_skills1`
    ...
    REFERENCES `new`.`skills` (`idskills`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
