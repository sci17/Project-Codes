...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`PURCHASE_STATUS_CODES` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`INVENTORY_ITEM_TYPES` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`INVENTORY_ITEMS` (
  ...
  CONSTRAINT `fk_INVENTORY_ITEMS_INVENTORY_ITEM_TYPES1`
    ...
    REFERENCES `rental`.`INVENTORY_ITEM_TYPES` (`item_type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`TRANSACTION_TYPES` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`CUSTOMERS` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`CUSTOMER_ITEM_PURCHASES` (
  ...
  CONSTRAINT `fk_PURCHASE_STATUS_CODES_has_CUSTOMERS_PURCHASE_STATUS_CODES`
    ...
    REFERENCES `rental`.`PURCHASE_STATUS_CODES` (`purchase_status_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PURCHASE_STATUS_CODES_has_CUSTOMERS_CUSTOMERS1`
    FOREIGN KEY (`customer_id`)
    REFERENCES `rental`.`CUSTOMERS` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CUSTOMER_ITEM_PURCHASES_INVENTORY_ITEMS1`
    FOREIGN KEY (`item_id`)
    REFERENCES `rental`.`INVENTORY_ITEMS` (`item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`PAYMENT_METHODS` (
...
-- Table `mydb`.`ACCOUNTS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`ACCOUNTS` (
  ...
  CONSTRAINT `fk_ACCOUNTS_PAYMENT_METHODS1`
    ...
    REFERENCES `rental`.`PAYMENT_METHODS` (`payment_method_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`CUSTOMER_ITEM_RENTALS` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `rental`.`FINANCIAL_TRANSACTIONS` (
