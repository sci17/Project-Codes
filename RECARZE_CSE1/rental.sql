...
-- Schema mydb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `finalDrill` DEFAULT CHARACTER SET utf8 ;
USE `finalDrill` ;

-- -----------------------------------------------------
-- Table `mydb`.`PURCHASE_STATUS_CODES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`PURCHASE_STATUS_CODES` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`INVENTORY_ITEMS` (
  ...
  CONSTRAINT `fk_INVENTORY_ITEMS_INVENTORY_ITEM_TYPES1`
    ...
    REFERENCES `finalDrill`.`INVENTORY_ITEM_TYPES` (`item_type_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`TRANSACTION_TYPES` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`CUSTOMERS` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`CUSTOMER_ITEM_PURCHASES` (
  `purchase_id` INT NOT NULL,
  `purchase_status_code` INT NULL,
  ...
  CONSTRAINT `fk_PURCHASE_STATUS_CODES_has_CUSTOMERS_PURCHASE_STATUS_CODES`
    ...
    REFERENCES `finalDrill`.`PURCHASE_STATUS_CODES` (`purchase_status_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PURCHASE_STATUS_CODES_has_CUSTOMERS_CUSTOMERS1`
    FOREIGN KEY (`customer_id`)
    REFERENCES `finalDrill`.`CUSTOMERS` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_CUSTOMER_ITEM_PURCHASES_INVENTORY_ITEMS1`
    FOREIGN KEY (`item_id`)
    REFERENCES `finalDrill`.`INVENTORY_ITEMS` (`item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`PAYMENT_METHODS` (
...
-- Table `mydb`.`ACCOUNTS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`ACCOUNTS` (
  ...
  CONSTRAINT `fk_ACCOUNTS_PAYMENT_METHODS1`
    ...
    REFERENCES `finalDrill`.`PAYMENT_METHODS` (`payment_method_code`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`CUSTOMER_ITEM_RENTALS` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `finalDrill`.`FINANCIAL_TRANSACTIONS` (
